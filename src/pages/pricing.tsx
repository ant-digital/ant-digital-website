...
const Pricing = () => {
  return (
    <Layout>
      ...
      <div className="m-8 p-8 border border-primary border-2 rounded-xl lg:flex">
      ...
      <div className="m-8 p-8 border-green-400 border-2 rounded-xl border lg:flex ">
        <div className={"flex-2 prose"}>
          <h2>E-commerce</h2>
          <p>
      ...
      <div className="m-8 p-8 border border-red-400 border-2 rounded-xl lg:flex">
        <div className={"flex-2 prose"}>
