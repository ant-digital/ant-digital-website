...
const Navbar: FC = () => (
  <nav className="sticky left-0 right-0 top-0 justify-end z-20 bg-white bg-opacity-50 firefox:bg-opacity-90 backdrop-filter backdrop-blur border-b border-black border-opacity-10">
